...
class AkShareProvider(BaseDataProvider):
    ...
    async def initialize(self) -> bool:
        """Lazy load libraries."""
        try:
            # Note: AkShare doesn't support explicit proxy configuration
            # If DATA_PROXY is set, http_crawler_provider should be preferred
            from app.core.config import settings
            if settings.DATA_PROXY:
                logger.info("DATA_PROXY is set - AkShare may fail, will fallback to http_crawler")
